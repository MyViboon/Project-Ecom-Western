...
-- AddForeignKey
ALTER TABLE `ProducetOnCart` ADD CONSTRAINT `ProducetOnCart_cardId_fkey` FOREIGN KEY (`cardId`) REFERENCES `Cart`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `ProducetOnCart` ADD CONSTRAINT `ProducetOnCart_productId_fkey` FOREIGN KEY (`productId`) REFERENCES `Product`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
